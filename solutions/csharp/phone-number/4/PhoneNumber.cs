public class PhoneNumber
{
    ...
    static public void ThrowIfNumberInvalid(string phoneNumber)
    {
        ...
        if (NumberHasInValidDigits(phoneNumber, twoToNineNumIdxs, (lowerBound: '2', upperBound: '9')))
            throw new ArgumentException(message: InvalidNumberError, nameof(phoneNumber));
    }
    ...
    {
        char[] punctuation = ['-', '(', ')', ' ', '.', '+'];
        var parsedNum = string.Concat(phoneNumber.Where(c => !punctuation.Contains(c)))!;
