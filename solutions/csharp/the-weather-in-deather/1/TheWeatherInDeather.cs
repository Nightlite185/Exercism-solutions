public class WeatherStation
{
    ...
    {
        object when reading.Equals(new Reading()) => throw new ArgumentException(),

        object when reading.Pressure < 10m && reading.Temperature < 30m => Outlook.Cool,

        object when reading.Temperature > 50 => Outlook.Good,
